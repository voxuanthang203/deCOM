...
DEFAULTS = {
    ...
    "NONCE_LEN": 24,
    "VALIDATION_SERIALIZER": "backend.metamask.serializers.WalletTokenObtainSerializer",
    "WALLET_AUTHENTICATION_SERIALIZER": "backend.metamask.serializers.WalletAuthSerializer",
